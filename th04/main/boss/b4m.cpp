...
// [MOD] The original division by zero ("Divide Error") for [duration] values
// of 12 or 13 is worked around per the ReC98 `th04_marisa4_crash_still`
// branch (community choice): Marisa simply doesn't move in that case.
