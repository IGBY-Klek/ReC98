...
var_4		= dword	ptr -4
		...
		graph_accesspage 0
		graph_showpage al
		call	graph_putsa_fx pascal, (16 shl 16) or  48, V_WHITE, ds, offset aB@b@b@b@b@b@b@ ; "　　　　　　　 成績判定"
		call	graph_putsa_fx pascal, (16 shl 16) or  72, V_WHITE, ds, offset aUqiUx	; "難易度"
		call	graph_putsa_fx pascal, (16 shl 16) or  96, V_WHITE, ds, offset aNPiuU_	; "最終得分"
		call	graph_putsa_fx pascal, (16 shl 16) or 120, V_WHITE, ds, offset aGGxi	; "失敗回数"
		call	graph_putsa_fx pascal, (16 shl 16) or 144, V_WHITE, ds, offset aGGaogcpi ; "Ｂｏｍｂ使用回数"
		call	graph_putsa_fx pascal, (16 shl 16) or 168, V_WHITE, ds, offset aGqbGatbrmcj ; "遊戲達成率"
		call	graph_putsa_fx pascal, (16 shl 16) or 192, V_WHITE, ds, offset aIlcSObcj ; "悪霊退治率"
		call	graph_putsa_fx pascal, (16 shl 16) or 216, V_WHITE, ds, offset aGagcgegai ; "資源回収率"
		call	graph_putsa_fx pascal, (16 shl 16) or 240, V_WHITE, ds, offset aUU_gagcgeganNv ; "Ｉｔｅｍ得分最高分率"
		call	graph_putsa_fx pascal, (16 shl 16) or 264, V_WHITE, ds, offset aLcnzvv	; "気勢"
		call	graph_putsa_fx pascal, (16 shl 16) or 288, V_WHITE, ds, offset aPicacovCj ; "掉幀率"
		call	graph_putsa_fx pascal, (16 shl 16) or 336, V_WHITE, ds, offset aVavVVSrso ; "?的成績是"
		les	bx, _resident
...
loc_BC79:
		...
		push	ax	; num
		call	@graph_3_digit_put$qiiu
		call	graph_putsa_fx pascal, (288 shl 16) or 120, 14, ds, offset aTimes	; "次"
		call	graph_putsa_fx pascal, (288 shl 16) or 144, 14, ds, offset aTimes_0	; "次"
		mov	byte_124CC, 1
		les	bx, _resident
		cmp	es:[bx+resident_t.stage], STAGE_EXTRA
		jz	short loc_BD0A
...
loc_BFD9:
		...
		call	graph_putsa_fx pascal, (288 shl 16) or 336, 14, ds, offset aPoint	; "分"
		push	ds
...
loc_C0AE:
		call	graph_putsa_fx pascal, (192 shl 16) or 336, 14, ds, offset aBhbhbhbhbhbhu_ ; "？？？？？？分"
		push	(64 shl 16) or 360
		push	V_WHITE
		push	ds
...
aBd_0		db '．',0
aBu_0		db '％',0
aB@b@b@b@b@b@b@	db '　　　　　　　 成績判定',0
aUqiUx		db '難易度',0
aNPiuU_		db '最終得分',0
aGGxi		db '失敗回数',0
aGGaogcpi	db 'Ｂｏｍｂ使用回数',0
aGqbGatbrmcj	db '遊戲達成率',0
aIlcSObcj	db '悪霊退治率',0
aGagcgegai	db '資源回収率',0
aUU_gagcgeganNv	db 'Ｉｔｅｍ得分最高分率',0
aLcnzvv		db '気勢',0
aPicacovCj	db '掉幀率',0
aVavVVSrso	db '?的評分是',0
aTimes		db '回',0
aTimes_0	db '回',0
aPoint		db '分',0
a_ude_txt	db '_ude.txt',0
aBhbhbhbhbhbhu_	db '？？？？？？分',0
aPicacovVVcvsfT	db '幀率問題無法判定',0
aUde_pi		db 'ude.pi',0
		db    0
...
aGxgnbGvbGhvVGv	db '慢速模式不記録成績',0
aGxgnbGvbGhvV_1	db '慢速模式不記録成績',0
aName		db 'name',0
		db    0
