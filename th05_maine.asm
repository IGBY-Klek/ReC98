...
var_4		= dword	ptr -4
		...
		push	col_116E4
		push	ds
		push	offset aGqbGatbrmcj ; "遊戲達成率"
		call	graph_putsa_fx
		push	x_116E2
		mov	ax, y_116E8
		add	ax, 144
		...
		push	col_116E4
		push	ds
		push	offset aUU_gagcgeganNv ; "Ｉｔｅｍ得分最高分率"
		call	graph_putsa_fx
		push	x_116E2
		mov	ax, y_116E8
		add	ax, 216
...
loc_D120:
		...
		push	word_116E6
		push	ds
		push	offset aPicacovVVcvsfT ; "幀率問題無法判定"
		call	graph_putsa_fx
...
aGxgnbGvbGhvV_0	db '慢速模式不記録成績',0
aName		db 'name',0
		db 0
x_116E2	dw 336
col_116E4	dw 2
